...
const routerRaw = [
    ...
    { path: '/blog',        component: BlogView,        meta: { navTitle: '建文',   navIcon: IconName.Blog,    showInNav: true,    order: 3 ,  sidebarType:SidebarType.None} },
    { path: '/wish',        component: WishlistView,    meta: { navTitle: '心愿单', navIcon: IconName.Wish,    showInNav: true,    order: 4 ,  sidebarType:SidebarType.None} },
    { path: '/option',    component: OptionAccountView, meta: { navTitle: '配置',   navIcon: IconName.Random,  showInNav: false,   order: 5 ,  sidebarType:SidebarType.None} },
