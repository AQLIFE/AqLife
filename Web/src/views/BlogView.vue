...
import { Configuration, FileApi } from '@/api/generated'
import type { FileDto } from '@/api/generated/models/FileDto'
...
const blogList: Ref<Array<FileDto>> = ref<Array<FileDto>>([])
...
onMounted(async () => {
  ...
  const response = await fileApi.apiFileGetRaw({ title: '', id: '' })
  let result = null
  //   console.log(result)
