...
{
    public record TodoQuery(Guid? UID=null,string? Desc=null) : IQuery<IEnumerable<TodoDto>?>;
    ...
    public record UpdateTodoCommand(Guid UID,string Desc, [property:JsonConverter(typeof(JsonStringEnumConverter))] TodoStatus Status) : IRequireValidEntity<TodoEntity>, IUpdateCommand;
