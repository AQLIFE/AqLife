...
{
    public class UpdateFileHandler(IApplicationDbContext appStorage, IFileStorage fileStorage, UploadContext uploadContext,FileWriter fileWriter) : IRequestHandler<UpdateFileCommand, Guid>
    {
